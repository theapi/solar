...
**********************************************************/
//RFM95
const u8  C_RFM95_ModuleName[]={"95  "};
const u16 C_RFM95_FreqBuf[]={868,915,0};
const u8  C_RFM95_RateBuf[]={12,24,48,96,0};
const u8  C_RFM95_PowerBuf[]={20,17,13,11,0};
const u8  C_RFM95_FdevBuf[]={35,0};
const u8  C_RFM95_BandBuf[]={83,0};
const u8  C_RFM95_RSSIBuf[]={25,50,70,95,0};
const u8  C_RFM95_ModemBuf[]={C_SysMode_LoRa,C_SysMode_FSK,0};
const u8  C_RFM95_SpreadFactorBuf[]={6,7,8,9,10,11,12,0};
const u16 C_RFM95_LoRaBandBuf[]={78,104,156,208,312,417,625,1250,2500,5000,0};
const u8  C_RFM95_LoRaRSSIBuf[]={40,60,90,120,0};
