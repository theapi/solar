...
{ 
  ...
  RF_ModemBuf=(u8*)C_RFM95_ModemBuf;
  if(RF_ModemBuf[gb_Modem_Addr]==C_SysMode_FSK)
  {
    RF_ModuleName=(u8*)C_RFM95_ModuleName; 
    RF_FreqBuf=(u16*)C_RFM95_FreqBuf;
    RF_RateBuf=(u8*)C_RFM95_RateBuf;
    RF_PowerBuf=(u8*)C_RFM95_PowerBuf;
    RF_FdevBuf=(u8*)C_RFM95_FdevBuf;
    RF_BandBuf=(u8*)C_RFM95_BandBuf;  
    RF_RSSIBuf=(u8*)C_RFM95_RSSIBuf;
  }
  else if(RF_ModemBuf[gb_Modem_Addr]==C_SysMode_LoRa)
  {
    ...
    RF_PowerBuf=(u8*)C_RFM95_PowerBuf;
    RF_FdevBuf=(u8*)C_RFM95_FdevBuf;
    RF_RateBuf=(u8*)C_RFM95_SpreadFactorBuf;
    RF_LoRaBandWidthBuf=(u16*)C_RFM95_LoRaBandBuf;  
    RF_RSSIBuf=(u8*)C_RFM95_LoRaRSSIBuf;
    gb_RateBuf_Addr=3;
    gb_BandBuf_Addr=7;
  }
